...
namespace ItemChanger
{
    ...
    public class StartDef
    {
        ...
        private static IEnumerator OnRespawn(On.HeroController.orig_Respawn orig, HeroController self)
        {
            ...
            if (e != null && e.GetType().Name != "<Respawn>d__473")
            {
                while (e.MoveNext())
                {
                    if (e.Current != null && e.Current.GetType().Name == "<Respawn>d__473")
                    {
            ...
            FieldInfo state = r.GetType().GetField("<>1__state", BindingFlags.Instance | BindingFlags.NonPublic);
            int GetState() => (int)state.GetValue(r);
            void SetState(int i) => state.SetValue(r, i);
            FieldInfo spawn = r.GetType().GetField("<spawnPoint>5__2", BindingFlags.Instance | BindingFlags.NonPublic);
